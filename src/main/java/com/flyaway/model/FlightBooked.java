...
public class FlightBooked {
	 ...
	 * @param sourceAirportName
	 * @param destAirportCode
	 * @param destAirportName
	 * @param totalPassengers
	 * @param totalFare
	 */
	public FlightBooked(int bookingid, String bookingStatus, String purchaseDate, int flightNumber, String airline,
	...
	public String toString() {
		return "FlightBooked [bookingid=" + bookingid + ", bookingStatus=" + bookingStatus + ", purchaseDate="
